...
Añade `sparquet` a las librerías del clúster, o instálalo en un cuaderno:
...
3. Abre [http://localhost:5273](http://localhost:5273). El primer arranque crea un Workflow **Getting Started** con Jobs que funcionan.
...
Imprime un token al arrancar; pégalo en **Settings → Local runner** del Studio. El procedimiento completo está en [Ejecutar un Job](/es/docs/studio/running/).
