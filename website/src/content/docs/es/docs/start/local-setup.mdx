...
3. Abre [http://localhost:5273](http://localhost:5273). El primer inicio siembra un proyecto **Getting Started** con pipelines funcionales.
...
- El flujo completo de ejecución, endpoints y solución de problemas: [Ejecución de pipelines](/es/docs/studio/running/).
