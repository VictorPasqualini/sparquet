...
`sparquet-cola` es un paquete propio ([repo](https://github.com/VictorPasqualini/sparquet-cola)). Instálalo standalone, o recíbelo automáticamente como dependencia de `sparquet`:
