...
```json title="pedidos_curados.json"
{
  ...
  "input": {
    "format": "postgres",
    "path": "public.pedidos",
    "options": { "host": "db.interno", "database": "vendas", "password_env": "PG_PASSWORD" }
  },
  "transformations": [
...
3. **[Seu primeiro fluxo no Studio](/pt/docs/start/first-flow/)** — o mesmo pipeline, desenhado no canvas.
