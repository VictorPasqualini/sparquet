...
3. Abra [http://localhost:5273](http://localhost:5273). A primeira execução cria um Workflow **Getting Started** com Jobs funcionando.
...
Ele imprime um token na subida; cole em **Settings → Local runner** no Studio. O procedimento completo está em [Executando um Job](/pt/docs/studio/running/).
