...
O serviço não está rodando, ou a URL em **Settings → Local runner** não bate. Veja [Executando pipelines](/pt/docs/studio/running/).
...
**Meu trabalho sumiu**
O Studio guarda projetos no IndexedDB do navegador. Limpar os dados do site os apaga, e um navegador ou perfil diferente tem a própria cópia. Exporte em **Settings → Data**, e commite os pipelines compilados no git.
