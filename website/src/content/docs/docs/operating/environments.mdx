...
Store pipelines in a Repo so they are versioned with the rest of the code. Job parameters map straight onto `params`. Secrets belong in a scope, exposed as environment variables to the job.
