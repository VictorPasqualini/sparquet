...
This page takes a machine with nothing installed and ends with a pipeline you built on the canvas, executed against real Spark, showing its result. It ties together the [install](/docs/start/install/) and [running a job](/docs/studio/running/) pages into one ordered path — follow it top to bottom the first time.
...
- The full run flow, endpoints and troubleshooting: [Running a job](/docs/studio/running/).
