...
`sparquet-cola` is its own package ([repo](https://github.com/VictorPasqualini/sparquet-cola)). Install it standalone, or get it automatically as a dependency of `sparquet`:
