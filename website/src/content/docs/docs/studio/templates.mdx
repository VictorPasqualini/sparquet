...
description: Ten working jobs and six guided lessons that ship with Sparquet Studio.
sidebar:
  order: 7
---
...
| Staging view handoff | intermediate | Several Jobs composing through a temp view — the shape a [Pipeline](/docs/studio/pipelines/) automates |
