...
| Studio | — | 440 tests + 19 smoke checks |
| Runner service (`server/`) | — | 91 `unittest` tests (history 48, auth 33, workspace 10) |
...
The Studio is the best-covered part of the project (440 unit tests, 19 smoke checks in
