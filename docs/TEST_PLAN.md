...
| Runner service (`server/`) | — | 243 `unittest` tests (history 64, auth 64, credits 71, audit 18, run scope 16, workspace 10) |
...
a real Chrome, and 243 `unittest` tests on the runner: 64 on the history database, 64 on
