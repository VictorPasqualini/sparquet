...
| Studio | — | 464 tests + 21 smoke checks |
| Runner service (`server/`) | — | 227 `unittest` tests (history 48, auth 64, credits 71, audit 18, run scope 16, workspace 10) |
...
The Studio is the best-covered part of the project (464 unit tests, 21 smoke checks in
a real Chrome, and 227 `unittest` tests on the runner: 48 on the history database, 64 on
